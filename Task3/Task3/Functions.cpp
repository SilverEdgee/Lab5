...
int main();
void DisplayTask() {
	std::cout << "Дан двумерный динамический массив целых чисел A размерностью n x k.\n";
	std::cout << "Размерность массива вводится с клавиатуры.\n";
	std::cout << "Значения элементов массива также вводятся с клавиатуры.\n";
	std::cout << "Создать динамический массив из элементов, расположенных на главной диагонали матрицы и имеющих четное значение.\n";
	std::cout << "Вычислить произведение элементов этого динамического массива.\n\n";
}
int ifInt() {
